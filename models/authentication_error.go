...
type AuthenticationError struct {
	...
	// an optimal field name to which this validation error applies
	Field string `json:"field,omitempty"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *AuthenticationError) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 Error
...
func (m AuthenticationError) MarshalJSON() ([]byte, error) {
